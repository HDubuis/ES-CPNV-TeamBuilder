...
(
    ...
    INDEX `fk_members_status_idx` (`status_id` ASC) VISIBLE,
...
values ('Anthony', 'Anthony''s_Pa$$w0rd', 1,2),
       ('Armand', 'Armand''s_Pa$$w0rd', 1,1),
       ('Cyril', 'Cyril''s_Pa$$w0rd', 1,1),
       ('Filipe', 'Filipe''s_Pa$$w0rd', 1,1),
       ('Helene', 'Helene''s_Pa$$w0rd', 1,1),
       ('Mario', 'Mario''s_Pa$$w0rd', 1,2),
       ('Mathieu', 'Mathieu''s_Pa$$w0rd', 1,1),
       ('Mauro', 'Mauro''s_Pa$$w0rd', 1,3),
       ('Melodie', 'Melodie''s_Pa$$w0rd', 1,2),
       ('Noah', 'Noah''s_Pa$$w0rd', 1,2),
